	...
	<div class="main-panel">
		<div class="content-wrapper">
			<div class="page-header">
				<h3 class="page-title">Tambah Data Penduduk</h3>
						...
						<div class="card-body">
							<form action="<?= base_url('KasiKependudukan/cPenduduk/create') ?>" method="POST" class="forms-sample">
								<div class="form-group">
									...
									<input type="number" min="16" max="16" name="nik" class="form-control" id="exampleInputName1" placeholder="Masukkan NIK" />
									<?= form_error('nik', '<small class="text-danger">', '</small>') ?>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail3">Nama Kepala Keluarga</label>
									<input type="text" name="nama_kk" class="form-control" id="exampleInputEmail3" placeholder="Masukkan Kepala Keluarga" />
									<?= form_error('nama_kk', '<small class="text-danger">', '</small>') ?>
								</div>
								<div class="form-group">
									<label for="exampleInputPassword4">Alamat</label>
									<input type="text" name="alamat" class="form-control" id="exampleInputPassword4" placeholder="Masukkan Alamat" />
									<?= form_error('alamat', '<small class="text-danger">', '</small>') ?>
								</div>
								<div class="form-group">
									<label for="exampleInputPassword4">Nama Ayah</label>
									<input type="text" name="nama_ayah" class="form-control" id="exampleInputPassword4" placeholder="Masukkan Nama Ayah" />
									<?= form_error('nama_ayah', '<small class="text-danger">', '</small>') ?>
								</div>
								<div class="form-group">
									<label for="exampleInputPassword4">Nama Ibu</label>
									<input type="text" name="nama_ibu" class="form-control" id="exampleInputPassword4" placeholder="Masukkan Nama Ibu" />
									<?= form_error('nama_ibu', '<small class="text-danger">', '</small>') ?>
								</div>
								<div class="form-group">
									<label for="exampleInputPassword4">Jumlah Anak</label>
									<input type="number" name="jml" class="form-control" id="exampleInputPassword4" placeholder="Masukkan Jumlah Anak" />
									<?= form_error('jml', '<small class="text-danger">', '</small>') ?>
								</div>
								<div class="form-group">
									<label for="exampleInputPassword4">Tanggal Lahir</label>
									<input type="date" name="tgl_lahir" class="form-control" id="exampleInputPassword4" placeholder="Masukkan Tanggal Lahir" />
